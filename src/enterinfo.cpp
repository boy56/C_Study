...
namespace compiler{
	void enter(std::string name, objecttyp obj, types typ){
		int j, l;
		if(tab.t == TMAX){
			fatal(1,lc);
		}
	...
	void printTab() {
		...
		tab_out_file.open("tabinfo/tab_out.txt", std::fstream::out);
	...
	void printATab() {
		...
		atab_out_file.open("tabinfo/atab_out.txt", std::fstream::out);
	...
	void printBTab() {
		...
		btab_out_file.open("tabinfo/btab_out.txt", std::fstream::out);
	...
	void printTMap() {
		...
		tmap_out_file.open("tabinfo/tmap_out.txt", std::fstream::out);
	...
	void printMidCode() {
		...
		MidCode_file.open("tabinfo/midcode_out.txt", std::fstream::out);
