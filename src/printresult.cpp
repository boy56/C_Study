...
namespace compiler {
	...
	void printMidResult() {
		...
		mid_result_file.open("result/15061098_司靖辉_优化前中间代码.txt", std::fstream::out);
	...
	void printMipsResult() {
		...
		mips_result_file.open("result/15061098_司靖辉_优化前目标代码.txt", std::fstream::out);
	...
	void printMidOptResult() {
		std::fstream mid_result_file;
		mid_result_file.open("result/15061098_司靖辉_优化后中间代码.txt", std::fstream::out);
		mid_result_file << "RET: func_return_value" << std::endl;
		mid_result_file << std::endl;
	...
	void printMipsOptResult() {
		std::fstream mips_result_file;
		mips_result_file.open("result/15061098_司靖辉_优化后目标代码.txt", std::fstream::out);
		mips_result_file << "# Please set to begin at \"main\"" << std::endl;
		mips_result_file << ".globl main" << std::endl;
		mips_result_file << ".data" << std::endl;
		//存放字符串以便打印
